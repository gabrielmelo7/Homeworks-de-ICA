...
def scatter_plot_predictors(df : pd.core.frame.DataFrame, target: str, number_of_plots: int) -> None:
    ...
    Args:
        ...
        number_of_plots (int): How many variables are going to be selected to plot 
    ...
    # We decide which of them are going to be shown using correlation coefficient and then select the given number of attributes
    corr_matrix = df.corr()
